...
**POST** `/api/subscribe?customerNumber={customerNumber}`
...
```http
POST /api/subscribe?customerNumber=CUST001
```
...
```http
POST /api/loanRequest?customerNumber=CUST001&amount=10000
```
...
```http
GET /api/loanStatus?customerNumber=CUST001
```
